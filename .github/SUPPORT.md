# Getting help with equationer

Thanks for using equationer. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/equationer/issues) to make sure the 

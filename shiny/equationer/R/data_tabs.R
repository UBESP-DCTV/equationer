...
measurements_tab <- function() {
  tabPanel(strong("Measurements"), icon = icon("file-medical"),
    flowLayout(
...
conditions_tab <- function() {
  tabPanel(strong("Conditions"), icon = icon("file-medical"),
    flowLayout(
...
lab_tests_tab <- function() {
  tabPanel(strong("Lab tests"), icon = icon("file-medical"),
    flowLayout(
...
physical_activity_tab <- function() {
  tabPanel(strong("Physical activity"), icon = icon("file-medical"),
    flowLayout(
...
environment_tab <- function() {
  tabPanel(strong("Environment"), icon = icon("file-medical"),
    flowLayout(
...
vital_parameters_tab <- function() {
  tabPanel(strong("Vital parameters"), icon = icon("file-medical"),
    flowLayout(
...
outcomes_tab <- function() {
  tabPanel(strong("Outcome of interest"), icon = icon("bullseye"),
    fluidRow(

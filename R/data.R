...
#'   air_temperature, albumin_mg_dl, bmi, bmi_pavlidou, glucose_g_dl,
#'   height, intercept, lbm, livingston_weight_age,
#'   livingston_weight_alone, livingston_weight_f,
#'   livingston_weight_f_alone, livingston_weight_m,
#'   livingston_weight_m_alone, lta, mean_chest_skinfold, menopausal,
#'   subscapular_skinfold, surface_area, var_metsios, weight,
#'   wrist_circumferenc }
#'   \item{Strata included}{age_18_74, age_60_70, age_60_74,
#'   arthritis_reumatoide, bmi_class, bmi_greater_21, copd, diabetic,
